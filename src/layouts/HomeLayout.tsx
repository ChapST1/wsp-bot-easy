  ...
  return (
    <section className='h-screen flex items-center justify-center'>
      ...
      <div className='flex flex-col items-center justify-between  gap-2'>
        ...
        <Link to='/login' className='inline-flex h-12 hover:animate-background-shine items-center justify-center rounded-md border border-[#1f2123] bg-[linear-gradient(110deg,#000103,60%,#1c1d1d,70%,#000103)] bg-[length:200%_100%] px-6 font-medium text-[#93989d] transition-colors focus:outline-none hover:text-[#eaebec] duration-300 '>
          Empezar
        </Link>
      </div>
    </section>
