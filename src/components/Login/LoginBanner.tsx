...
export function LoginBanner () {
  return (
    <div className='w-full  bg-[#000] md:rounded-md p-8 md:p-14 md:pt-20 border border-white/10 border-b-0 relative'>
      <LightEffect />
      <h3 className='text-white text-2xl text-center md:text-start md:text-3xl '>Inicia sesion con WhatsApp</h3>
      ...
      <h2 className='text-white text-2xl text-center py-7'>Tutorial</h2>
      <img
